...
public class ProductsDAOImplTest {
    ...
    private static final int EXPECTED_PRODUCT_SUPPLIER_ID = 12;
    ...
    private static final int NEW_PRODUCT_SUPPLIER_ID = 1;
    ...
    static {
        EXPECTED_PRODUCT = new Products(EXPECTED_PRODUCT_NAME, EXPECTED_PRODUCT_SUPPLIER_ID,
        ...
        NEW_PRODUCT = new Products(NEW_PRODUCT_NAME, NEW_PRODUCT_SUPPLIER_ID,
    ...
    public void addProduct() throws Exception {
        ...
        Assert.assertEquals(NEW_PRODUCT.getSupplierid(), objectUnderTest.getProductById(currentProductsQuantity + 1).getSupplierid());
    ...
    public void updateProduct() throws Exception {
        ...
        Assert.assertEquals(EXPECTED_PRODUCT.getSupplierid(), products.getSupplierid());
        ...
        products.setSupplierid(NEW_PRODUCT_SUPPLIER_ID);
        ...
        Assert.assertEquals(NEW_PRODUCT_SUPPLIER_ID, objectUnderTest.getProductById(EXPECTED_PRODUCT_ID).getSupplierid());
        ...
        products.setSupplierid(EXPECTED_PRODUCT_SUPPLIER_ID);
